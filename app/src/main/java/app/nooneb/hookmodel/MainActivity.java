...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.append("移除技能：[110021,140101,140188,140187,140186,140157],[110031,110032,120040,120041,120042,120043,120044,120051,120052,120066,120067,120068,120069,120070,120071,120056,120057,120058,140064,140065,140066,140095,140096,140097,140098,140099,140131,140132,110012,110013,140190,140059,140062]\n");     // 继续追加
        ...
        textView.append("版本1.94最终版，扩展hook范围，只要包名含xkqz关键字可hook，但以com.sy.xkqz.tap为准，其他包不一定能用\n");
